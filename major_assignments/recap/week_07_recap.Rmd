...
#### **XQ10** I'm interested, in the future, to see the hours in which earthquakes happen. How can I extract the hour from the time column?
...
Where are the explosions happening? Create a new data set with only the explosions in it.
