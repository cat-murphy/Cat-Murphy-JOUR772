...
3.  How many of the classes are 500-level classes or higher? Is there is a noticeable difference in the median number of seats between undegraduate classes and graduate classes? In other words, do graduate classes tend to be smaller, larger or around the same size? Does this differ by department?
