...
-   Part I: The results generally show an increase in calls during the warmer months. From May to August, with only a couple exceptions, each county recorded at least 40 overdose calls to 911. This is in stark contrast to the cooler months, when some counties were recording as few as 17 calls and the average was closer to 30-35 calls per month.
