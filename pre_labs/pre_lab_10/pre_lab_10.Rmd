...
zip_codes_with_foreclosures <- md_zips |> 
  left_join(foreclosure_zip_march_2023, join_by(ZIPCODE1==zip))
```
...
md_county_notices <- read_csv("data/Maryland_Foreclosure_Data_by_County.csv") |> 
  slice(1) |> 
  pivot_longer(cols=-c('Date', 'Type'), names_to='county', values_to = 'notices')
...
**Answer:** Geographically speaking, most of the counties in northern and western Maryland have lower per capita rates of foreclosure notices compared to the middle of the state, where these rates spike. The map also shows that, generally speaking, the counties with [higher per capita personal income rates](https://msa.maryland.gov/msa/mdmanual/01glance/economy/html/income.html) tend to have lower rates of foreclosure notices. For example, Montgomery County, Howard County and Frederick County have among the lowest rates of foreclosure notices, and with per capita incomes over \$72,000 as of 2022, they are also among the wealthiest counties in Maryland. Neighboring Baltimore County, Carroll County and Anne Arundel County — all of which also have relatively high per capita incomes, between \$67,000 and \$79,000 — have only slightly higher rates of foreclosure notices. Other relatively wealthy counties like Queen Anne's, Talbot, Harford, Kent and Worcester also have low foreclosure notice rates. Meanwhile, the counties with lower per capita income rates, like Prince George's, Dorchester, Cecil, Baltimore City, Allegany and Caroline, also have higher per capita foreclosure notice rates. There are, of course, exceptions; Charles County has the higher per capita foreclosure notice rate, but a relatively mid-range per capita income at \$62,000. Calvert County is a similar situation. On the flip side, Garrett and Somerset counties are among the poorest counties, and yet have among the lowest foreclosure notice rates.
