...
**Answer: Now, because we've installed the `ggthemes` package, we can use its themes to style our charts. Here, we used `theme_economist()` to put our chart on a light blue background.**
