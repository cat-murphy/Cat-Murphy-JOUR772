...
**Answer: The header should be the first row, and the periods after the county names**
...
**Answer: Headers are numbered instead of named, and the periods after the county name will make everything harder.**
