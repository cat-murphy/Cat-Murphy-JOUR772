...
# ANSWERS, ISSUES & NOTABLE FINDINGS:
    ...
    # How did Hogan and Alsobrooks do in comparison to Trump and Harris? 
        ...
        # This suggests that a not insignificant number of people voted for both Hogan and Harris. The prevalence of split-ticket voting

        # Because Harris' 7.54-point lead on Alsobrooks does not fully account for 
